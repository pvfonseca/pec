...
% \begin{frame}{A interpretação hidráulica}
%     \begin{itemize}
%         \item O de Paul Samuelson de 1948 foi de fundamental importância, popularizando Keynes com o \textcolor{blue}{diagrama da cruz Keynesiana}
%         \bigskip
...
%         \bigskip
%         \item As ideias e desenvolvimentos da \textcolor{blue}{escola pós-Keynesiana} não serão vistas neste curso
%     \end{itemize}
% \end{frame}
...
%         \bigskip
%         \item Esta linha de pesquisa foi seguida por Clower (1956) e Leijonhufvud (1968), que desenvolveram uma abordagem de equilíbrio geral alternativa com características Walrasianas para incorporar os problemas de coordenação que emergem em uma economia de mercado operando sem a presença de um leiloeiro Walrasiano ficcional
%     \end{itemize}
% \end{frame}
...
%         \bigskip
%         \item No paradigma Walrasiano, todos os mercados estão continuamente em equilíbrio dada a presença de um leiloeiro fictício
%         \bigskip
